...
#Situation: You run a business. One of your clients has sent you an email saying they submitted an order incorrectly, and now you \
#must scan through your master file of clients and orders to find their order, and replace it with the correct one.
    ...
    with open('ClientList.txt', 'r') as clientnamesearch:
            ...
            for line in range(len(lines)):
                ...
                if target in lines[line]:
                    ...
                    #with this this defintion has served its purpose will now pass data to the function responsible for actually altering the file.
                    #mushing the list of lines created in the readlines method will also allow us to use .replace properly and not wipe out the entire text file
                    fullfile = ''.join(lines)
